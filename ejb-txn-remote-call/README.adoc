...
As the EJBs on the various servers perform transactional work against a database, it is needed to spin up a new PostgreSQL database.
...
For this quickstart, a simple PostgreSQL container will be used:
